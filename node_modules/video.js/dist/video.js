...
function _createXHR(options) {
    ...
    function loadFunc() {
        ...
        alert('邵肖桐 调试：'+response.rawRequest.bytesReceived);
        if (
            response.rawRequest.status === 404 &&
            response.rawRequest.responseURL.slice(-5).trim() === '.m3u8'
        ) {
          console.log('[drpeng]: load m3u8 address failure');
        }
